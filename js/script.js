...
window.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    const fallback = [
      { title:'Cadastro de Demandas', summary:'Centralização e priorização de demandas com KPIs e fluxo de aprovação.', category:['Power Apps','Automate'], status:'Entregue', tags:['Power Fx','SharePoint','UX'], links:{}, thumb:'assets/thumbs/cadastro.svg' },
      { title:'Rateio de Medição', summary:'Galeria flex e barra de progresso.', category:['Power Apps'], status:'Entregue', tags:['Excel'], links:{}, thumb:'assets/thumbs/rateio.svg' }
    ];
